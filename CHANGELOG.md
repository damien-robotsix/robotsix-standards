...
## [0.7.0](https://github.com/damien-robotsix/robotsix-standards/compare/v0.6.0...v0.7.0) (2026-09-26)


### ⚠ BREAKING CHANGES

* the documented level1-level4 scale is gone; consumers follow the llmio provider-failover rework (llmio#625).

### Features

* .secrets-patterns-excluded missing and detect-secrets --exclude-files integration absent (20260827T103739Z-secrets-patterns-excluded-missing-and-de-7e55) ([#322](https://github.com/damien-robotsix/robotsix-standards/issues/322)) ([2c585c6](https://github.com/damien-robotsix/robotsix-standards/commit/2c585c60b7974bf2a14642a69670ddd2f6b70fca))
* Remove obsolete docs/deploy-api-key.md — deploy-api-key provisioning retired fleet-wide (20260821T101853Z-remove-obsolete-docs-deploy-api-key-md-d-c43e) ([#310](https://github.com/damien-robotsix/robotsix-standards/issues/310)) ([508548e](https://github.com/damien-robotsix/robotsix-standards/commit/508548ecf137c53990f91ccac16adcb83285e2ac))
* Remove stale `config/vocabularies/` directory — Vale uses `styles/config/vocabularies/` (20260820T221509Z-remove-stale-config-vocabularies-directo-103e) ([#307](https://github.com/damien-robotsix/robotsix-standards/issues/307)) ([d6f18e1](https://github.com/damien-robotsix/robotsix-standards/commit/d6f18e196e36a523f0dce0051b78882b29002e46))
* Remove stale duplicate `config/vocabularies/` directory at repo root (20260806T222852Z-remove-stale-duplicate-config-vocabulari-742a) ([#258](https://github.com/damien-robotsix/robotsix-standards/issues/258)) ([85db405](https://github.com/damien-robotsix/robotsix-standards/commit/85db405d65ba1679692c5d7c50338b8a217b9004))
* robotsix-standards: Enable agent_check periodic workflow (20260828T112230Z-robotsix-standards-enable-agent-check-pe-9dd9) ([#325](https://github.com/damien-robotsix/robotsix-standards/issues/325)) ([c1e3f77](https://github.com/damien-robotsix/robotsix-standards/commit/c1e3f77d0420c9ac0dc2d5171646aa4429c07663))
* Standardize: multi-disk handling for component data volumes at deploy time (20260809T103118Z-standardize-multi-disk-handling-for-comp-abd6) ([#268](https://github.com/damien-robotsix/robotsix-standards/issues/268)) ([56a9d84](https://github.com/damien-robotsix/robotsix-standards/commit/56a9d8428a390073056bf5def7ecc075040bb837))
* Standardize: single-source versioning for Python repos via [tool.setuptools.dynamic] with attr: (20260812T225232Z-standardize-single-source-versioning-for-e345) ([#285](https://github.com/damien-robotsix/robotsix-standards/issues/285)) ([7fb611c](https://github.com/damien-robotsix/robotsix-standards/commit/7fb611c63bee12301f147cd26373892af7b3c841))


### Bug Fixes

* check-workflow-timeouts.py only detects 2-space job attributes — standard 4-space YAML makes the gate a no-op (20260903T225838Z-check-workflow-timeouts-py-only-detects-e413) ([#346](https://github.com/damien-robotsix/robotsix-standards/issues/346)) ([9116ab4](https://github.com/damien-robotsix/robotsix-standards/commit/9116ab4da5e75b73468060968b48702f48af29b7))
* completeness_check scan: 2 findings (2026-08-07) (20260807T203358Z-completeness-check-scan-2-findings-2026-50cd) ([#263](https://github.com/damien-robotsix/robotsix-standards/issues/263)) ([e383e3c](https://github.com/damien-robotsix/robotsix-standards/commit/e383e3c64b99c2a8200a2c6c50df702a86a605c8))
* Dependency-review severity threshold: repo-baseline (`high`) contradicts security-posture gate 2 (`moderate`) (20260821T181337Z-dependency-review-severity-threshold-rep-cf3e) ([#312](https://github.com/damien-robotsix/robotsix-standards/issues/312)) ([1b02222](https://github.com/damien-robotsix/robotsix-standards/commit/1b022225dda1d648ab2faff5fd3046810436572e))
* Enforcement CI lint for py.typed wheel-content guard -- scan workflow files and pyproject.toml for type-aware packages missing the assertion (20260807T132148Z-enforcement-ci-lint-for-py-typed-wheel-c-73c1) ([#262](https://github.com/damien-robotsix/robotsix-standards/issues/262)) ([69506d4](https://github.com/damien-robotsix/robotsix-standards/commit/69506d4d721eab054c1bc075986e6f28b15d30b4))
* Fix documentation inconsistencies (AGENT.md, mkdocs.yml, README status, entry ordering) (20260811T090644Z-fix-documentation-inconsistencies-agent-a133) ([#275](https://github.com/damien-robotsix/robotsix-standards/issues/275)) ([a96304a](https://github.com/damien-robotsix/robotsix-standards/commit/a96304a38064d0a35552a3c2f089592ef5f77764))
* Restore deleted Vale vocabulary files and revert docs path to canonical config/vocabularies/ (20260810T110701Z-restore-deleted-vale-vocabulary-files-an-1986) ([#272](https://github.com/damien-robotsix/robotsix-standards/issues/272)) ([2bfc45e](https://github.com/damien-robotsix/robotsix-standards/commit/2bfc45e86c41087d280039831b0ba22dea1f3680))


### Documentation

* Add changelog fragment for CSRF edge-handling standard (20260817T122827Z-add-changelog-fragment-for-csrf-edge-han-e519) ([#298](https://github.com/damien-robotsix/robotsix-standards/issues/298)) ([63b3cd8](https://github.com/damien-robotsix/robotsix-standards/commit/63b3cd812a4a4e557fd9372ba5e2d94a8909e114))
* Add CORS policy standard for HTTP-serving deployable components (20260908T092938Z-no-standard-defines-cors-handling-for-co-dae1) ([#355](https://github.com/damien-robotsix/robotsix-standards/issues/355)) ([ff3af60](https://github.com/damien-robotsix/robotsix-standards/commit/ff3af601c7f028a6fc5a029a1cfd1f2fc53717b1))
* Add ssrf-hardened-fetchers.md to mkdocs.yml nav and htmlproofer ignore_urls (20260829T021437Z-add-ssrf-hardened-fetchers-md-to-mkdocs-27f5) ([#331](https://github.com/damien-robotsix/robotsix-standards/issues/331)) ([b63b294](https://github.com/damien-robotsix/robotsix-standards/commit/b63b294ffefe7d1b95797c63d21b343372ddc11c))
* Align §7 Langfuse config block in docs/config-standard.md with the canonical block in docs/component-standard.md (20260808T043642Z-align-7-langfuse-config-block-in-docs-co-a33a) ([#265](https://github.com/damien-robotsix/robotsix-standards/issues/265)) ([c47b2cb](https://github.com/damien-robotsix/robotsix-standards/commit/c47b2cb9df0612896d9f675ddc7ee21b21e1aabc))
* annotate changelog-driven-releases nav entry as superseded (20260806T225402Z-annotate-changelog-driven-releases-nav-e-5a3e) ([#259](https://github.com/damien-robotsix/robotsix-standards/issues/259)) ([a180fdd](https://github.com/damien-robotsix/robotsix-standards/commit/a180fddfef5864ffc05e59963f944e77c78aa286))
* annotate the towncrier nav entry as superseded ([#321](https://github.com/damien-robotsix/robotsix-standards/issues/321)) ([9ee814a](https://github.com/damien-robotsix/robotsix-standards/commit/9ee814ae4ea44a8a4b948df87a14bbbb280c197d))
* Codify: CSRF is handled at the fleet edge (cookie SameSite policy) — components ship no CSRF logic (20260816T211739Z-codify-csrf-is-handled-at-the-fleet-edge-9a62) ([#294](https://github.com/damien-robotsix/robotsix-standards/issues/294)) ([d051331](https://github.com/damien-robotsix/robotsix-standards/commit/d051331e9f8a4d7f373a00cb2f9835ecb5199256))
* **component-standard:** make the CSRF-at-the-edge guarantee verifiable ([#308](https://github.com/damien-robotsix/robotsix-standards/issues/308)) ([e7b95f3](https://github.com/damien-robotsix/robotsix-standards/commit/e7b95f38cefa047faf31e60ee73c76198be67287))
* config-standard §7 truncated; component-standard missing LLM-tracing — Langfuse credential shape undefined (20260822T180451Z-config-standard-7-truncated-component-st-2a31) ([#315](https://github.com/damien-robotsix/robotsix-standards/issues/315)) ([cdbfa26](https://github.com/damien-robotsix/robotsix-standards/commit/cdbfa26912be65a4c951855ccd2789fb8ec03aba))
* config-standard.md: add OpenRouter config model to match component-standard.md canonical block (20260808T192841Z-config-standard-md-add-openrouter-config-65b3) ([#292](https://github.com/damien-robotsix/robotsix-standards/issues/292)) ([cc6f154](https://github.com/damien-robotsix/robotsix-standards/commit/cc6f154ee29355cb118125d801065d079c80725f))
* Define shared fleet config shapes (langfuse, LlmBackend, logging, host/port, github_app) (20260824T183130Z-define-shared-fleet-config-shapes-langfu-730d) ([#319](https://github.com/damien-robotsix/robotsix-standards/issues/319)) ([9241275](https://github.com/damien-robotsix/robotsix-standards/commit/9241275aa5c42efa04a5be05bf002c1186b6f388))
* finish the 2026-07 conformance outcomes (check-ast, debug-statements, dependency-review floor) (20260809T141805Z-docs-finish-the-2026-07-conformance-outc-19dd) ([#269](https://github.com/damien-robotsix/robotsix-standards/issues/269)) ([ffb52d3](https://github.com/damien-robotsix/robotsix-standards/commit/ffb52d353511b3527adb5497aa07f80558815ad3))
* http-security-headers.md: MUST rules lack enforcement mechanism; not discoverable from component-standard.md (20260829T174852Z-http-security-headers-md-must-rules-lack-9d37) ([#333](https://github.com/damien-robotsix/robotsix-standards/issues/333)) ([d669c47](https://github.com/damien-robotsix/robotsix-standards/commit/d669c4750422dee35812b5d1919717aadc9494fd))
* Langfuse config block: `project_id` field present in component-standard.md but missing from config-standard.md model (20260808T185141Z-langfuse-config-block-project-id-field-p-7497) ([#266](https://github.com/damien-robotsix/robotsix-standards/issues/266)) ([7bfb63e](https://github.com/damien-robotsix/robotsix-standards/commit/7bfb63ecba3b7851aacbe50811dbb09db02478f3))
* Langfuse credential shape: config-standard §7 and component-standard LLM tracing contradict on `project_id` (20260821T101954Z-langfuse-credential-shape-config-standar-c26a) ([#311](https://github.com/damien-robotsix/robotsix-standards/issues/311)) ([faffa9c](https://github.com/damien-robotsix/robotsix-standards/commit/faffa9cefb6d4d200148ca2ec2421f1072f2fb3b))
* LLM-usage standard — three levels, two provider slots, mandatory failover visibility ([#339](https://github.com/damien-robotsix/robotsix-standards/issues/339)) ([d1dd339](https://github.com/damien-robotsix/robotsix-standards/commit/d1dd339eb9b6d846c9953e478e9da16adea09d9c))
* OWASP Top 10 citation drift: Security Misconfiguration cited as A05:2021 in http-security-headers.md and sse-response-headers.md (current 2025 edition renumbers it A02) (20260908T021945Z-owasp-top-10-citation-drift-security-mis-542e) ([#354](https://github.com/damien-robotsix/robotsix-standards/issues/354)) ([a63a0fd](https://github.com/damien-robotsix/robotsix-standards/commit/a63a0fd6c97f91df18408f885b01f7f432ca5afc))
* repo-baseline: dependency-review severity clause is internally contradictory and conflicts with security-posture (20260822T122006Z-repo-baseline-dependency-review-severity-a921) ([#314](https://github.com/damien-robotsix/robotsix-standards/issues/314)) ([7c50c48](https://github.com/damien-robotsix/robotsix-standards/commit/7c50c48a2b3c3208e597891a4a118746bc1b0f22))
* security-posture gate 5 references missing secret-files-are-never-tracked.md (20260824T124302Z-security-posture-gate-5-references-missi-6dd9) ([#318](https://github.com/damien-robotsix/robotsix-standards/issues/318)) ([fcc77f6](https://github.com/damien-robotsix/robotsix-standards/commit/fcc77f6b45ec5424e6b458c7987b098d30fb53cf))
* security-posture.md gate 3 overstates Dependabot auto-merge — docker & pre-commit ecosystems are MUST-excluded per dependabot-auto-merge.md (20260908T092938Z-security-posture-md-gate-3-overstates-de-db3c) ([#356](https://github.com/damien-robotsix/robotsix-standards/issues/356)) ([51f45f1](https://github.com/damien-robotsix/robotsix-standards/commit/51f45f14c507f43f8b15a669a454c4bbc3178149))
* sse-response-headers.md: MUST rules lack enforcement mechanism; missing from component-standard.md contract (20260829T174852Z-sse-response-headers-md-must-rules-lack-c6ad) ([#334](https://github.com/damien-robotsix/robotsix-standards/issues/334)) ([4b48e7b](https://github.com/damien-robotsix/robotsix-standards/commit/4b48e7b7e811fd92ab433b92fbf2f0db81cc8830))
* Standard: config models must self-heal removed keys; feature removals must not crashloop on stale config (20260810T080302Z-standard-config-models-must-self-heal-re-fe78) ([#271](https://github.com/damien-robotsix/robotsix-standards/issues/271)) ([09526f1](https://github.com/damien-robotsix/robotsix-standards/commit/09526f161ff14569f624320fa5d271173c105460))
* Standardize: adopt Hypothesis for property-based testing in Python repos (20260820T232331Z-standardize-adopt-hypothesis-for-propert-6615) ([#309](https://github.com/damien-robotsix/robotsix-standards/issues/309)) ([4d2f811](https://github.com/damien-robotsix/robotsix-standards/commit/4d2f811cb8ad3cc6a90c918b728ab1bbb7e8d445))
* Standardize: Advisory mutmut mutation-testing cron for Python repos (20260817T083514Z-standardize-advisory-mutmut-mutation-tes-4daf) ([#297](https://github.com/damien-robotsix/robotsix-standards/issues/297)) ([51d655c](https://github.com/damien-robotsix/robotsix-standards/commit/51d655c1d699ca79b307a8ba7effee2e92a69ecd))
* Standardize: automated accessibility (axe-core) testing for frontend code (20260820T183908Z-standardize-automated-accessibility-axe-9219) ([#323](https://github.com/damien-robotsix/robotsix-standards/issues/323)) ([318fdbc](https://github.com/damien-robotsix/robotsix-standards/commit/318fdbc72cb7679223b470104fa00e7210386df8))
* Standardize: CI dependency management for Python repos (Renovate, uv lock --check, git-dep refresh) (20260807T224506Z-standardize-ci-dependency-management-for-fea8) ([#264](https://github.com/damien-robotsix/robotsix-standards/issues/264)) ([7e3db2d](https://github.com/damien-robotsix/robotsix-standards/commit/7e3db2df225b2c8781d0aff0b9b9a4ca1d5f0cb2))
* Standardize: dependency typing metadata declaration (20260903T182529Z-standardize-dependency-typing-metadata-d-4ad9) ([#342](https://github.com/damien-robotsix/robotsix-standards/issues/342)) ([c2df1fc](https://github.com/damien-robotsix/robotsix-standards/commit/c2df1fc989e70e85b57363fd8bcc51a126102ae2))
* Standardize: deprecation warnings and lifecycle policy for public APIs (20260903T190720Z-standardize-deprecation-warnings-and-lif-dca6) ([#343](https://github.com/damien-robotsix/robotsix-standards/issues/343)) ([d883f10](https://github.com/damien-robotsix/robotsix-standards/commit/d883f1003406c30f33be65b52738d9cdb08d04dd))
* Standardize: generate a real CycloneDX SBOM via `uv export` in CI (not `uv audit` output) (20260817T085200Z-standardize-generate-a-real-cyclonedx-sb-70c1) ([#304](https://github.com/damien-robotsix/robotsix-standards/issues/304)) ([b03ff31](https://github.com/damien-robotsix/robotsix-standards/commit/b03ff31bcabcee85b4577094a9026547ade794c1))
* Standardize: liveness vs readiness health-endpoint contract for fleet web services (20260818T231815Z-standardize-liveness-vs-readiness-health-5a93) ([#302](https://github.com/damien-robotsix/robotsix-standards/issues/302)) ([9398ab3](https://github.com/damien-robotsix/robotsix-standards/commit/9398ab337639b74bde488f6d26d49ee15c7f7df3))
* Standardize: Request ID tracking middleware for distributed observability (20260906T141901Z-standardize-request-id-tracking-middlewa-ccc3) ([#352](https://github.com/damien-robotsix/robotsix-standards/issues/352)) ([825c01f](https://github.com/damien-robotsix/robotsix-standards/commit/825c01ff985a9c47919258a2b92e01e72ccd1b86))
* Standardize: REUSE compliance and SPDX license headers (20260918T135124Z-standardize-reuse-compliance-and-spdx-li-875e) ([#382](https://github.com/damien-robotsix/robotsix-standards/issues/382)) ([65a8f20](https://github.com/damien-robotsix/robotsix-standards/commit/65a8f202b40397b3f6c0a115dea45d17ddc1219f))
* Standardize: SSE responses must set no-cache / keep-alive / X-Accel-Buffering headers (20260817T084701Z-standardize-sse-responses-must-set-no-ca-ce79) ([#305](https://github.com/damien-robotsix/robotsix-standards/issues/305)) ([dc7d15a](https://github.com/damien-robotsix/robotsix-standards/commit/dc7d15a79d78ec94b1f6d1fd10c75432af79ce97))
* Standardize: SSRF-hardened httpx fetchers must validate IPs at the connection layer (pin resolved IP, re-validate every redirect hop) (20260829T012110Z-standardize-ssrf-hardened-httpx-fetchers-1288) ([#330](https://github.com/damien-robotsix/robotsix-standards/issues/330)) ([9f51842](https://github.com/damien-robotsix/robotsix-standards/commit/9f51842ab4cf0f88ce2f4b644863f02e7cfe0399))
* Standardize: test documentation code examples so they can't drift from the API (20260820T191300Z-standardize-test-documentation-code-exam-9e16) ([#324](https://github.com/damien-robotsix/robotsix-standards/issues/324)) ([debc4c8](https://github.com/damien-robotsix/robotsix-standards/commit/debc4c8f7fba900764b120babe6042011168896d))
* Standardize: wire CONTRIBUTING.md into the MkDocs docs nav as a Contributing/Development page (20260806T185813Z-standardize-wire-contributing-md-into-th-da57) ([#280](https://github.com/damien-robotsix/robotsix-standards/issues/280)) ([34a1c07](https://github.com/damien-robotsix/robotsix-standards/commit/34a1c07c51d4dec5600f357e3405fa4ca46e7d86))
* timeout-minutes rule not enforced: reusable workflow callers exempt but undocumented, no CI gate (20260829T094956Z-timeout-minutes-rule-not-enforced-reusab-b2b1) ([#332](https://github.com/damien-robotsix/robotsix-standards/issues/332)) ([00a7a8c](https://github.com/damien-robotsix/robotsix-standards/commit/00a7a8cce176de38c094cf378c642617a02e8ac0))
* timeout-minutes rule scoped to Python CI only — non-Python workflow jobs uncovered and unenforced (20260828T103640Z-timeout-minutes-rule-scoped-to-python-ci-a1db) ([#326](https://github.com/damien-robotsix/robotsix-standards/issues/326)) ([886d406](https://github.com/damien-robotsix/robotsix-standards/commit/886d4065f647be7b72d927d3c81316a6dc324dfe))
* Update component-standard.md logging section to acknowledge structured-JSON standard (20260809T172129Z-update-component-standard-md-logging-sec-6b9d) ([#270](https://github.com/damien-robotsix/robotsix-standards/issues/270)) ([5cbf3d8](https://github.com/damien-robotsix/robotsix-standards/commit/5cbf3d860f262bf3b04660188d867bc66bfa9882))
* Update OWASP LLM Top 10 references from v2.0 (2025) to v3.0 (2026) in component-standard.md (20260807T011519Z-update-owasp-llm-top-10-references-from-3a39) ([#261](https://github.com/damien-robotsix/robotsix-standards/issues/261)) ([ee75588](https://github.com/damien-robotsix/robotsix-standards/commit/ee75588132321f314153b5e37b6e0406bde6b0c0))
* uv dependency updates: Dependabot config and two standards pages contradict the Renovate rule (20260817T074322Z-uv-dependency-updates-dependabot-config-b201) ([#296](https://github.com/damien-robotsix/robotsix-standards/issues/296)) ([c538eca](https://github.com/damien-robotsix/robotsix-standards/commit/c538eca73aad0445146fefda22220f6e26305edb))
