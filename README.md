...
| [Changelog & releases](docs/changelog-driven-releases.md) | Towncrier fragment-driven releases, CI-enforced changelog fragments, and the shared auto-release workflow — no hand-edited changelog. |
